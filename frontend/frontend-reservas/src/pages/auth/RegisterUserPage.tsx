        ...
        <div className="px-8 py-10 sm:p-12">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Regístrate para reservar canchas en los mejores clubes
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm text-blue-700">
                    Como usuario podrás reservar canchas en cualquier club, ver tus reservas y gestionar tu perfil.
                  </p>
                </div>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-3 border border-transparent text-lg font-bold rounded-xl text-white bg-gradient-to-br from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.02]"
            >
              {isLoading ? (
                <div className="flex items-center">
          ...
          <div className="mt-8 text-center space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                ¿Quieres registrar tu club?{' '}
                <Link to="/register-club" className="font-medium text-blue-600 hover:text-blue-500">
                  Registrar club
                </Link>
              </p>
            </div>
