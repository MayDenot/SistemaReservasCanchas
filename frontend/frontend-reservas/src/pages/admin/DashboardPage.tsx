...
const AdminDashboardPage: React.FC = () => {
  const {user, isSuperAdmin} = useUserRoles(); // Usa useUserRoles
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Bienvenido, <span className="font-bold text-purple-600">{user?.name}</span>
                <span className="ml-2 px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-bold">
                  SUPER ADMIN
                </span>
              </p>
            </div>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-6 mb-8">
                  <div
                    className={`w-16 h-16 ${stat.color} rounded-2xl flex items-center justify-center text-2xl text-white shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                    {stat.icon}
                  </div>
                  <div>
                    ...
                    {recentUsers.map((user) => (
                      <tr key={user.id.toString()}
                        ...
                        <td className="py-4 px-6">
                          <div className="flex items-center gap-4">
                            <div
                              className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
                        ...
                        <td className="py-4 px-6">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-bold ${user.userRole === 'CLUB_ADMIN' ? 'bg-gradient-to-r from-orange-100 to-amber-100 text-orange-700' : 'bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700'}`}>
                  ...
                  <table className="w-full">
                    ...
                    {recentReservations.map((reservation) => (
                      <tr key={reservation.id.toString()}
                        ...
                        <td className="py-4 px-6">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-bold ${getStatusBadge(reservation.status)}`}>
                        ...
                        <td className="py-4 px-6">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-bold ${getPaymentBadge(reservation.paymentStatus)}`}>
                  ...
                  {[
                    {
                      icon: '👤',
                      title: 'Crear usuario',
                      desc: 'Agregar nuevo usuario al sistema',
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className="w-12 h-12 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      text: 'Reserva #456789 cancelada por el usuario',
                      time: 'Hace 30 minutos'
                    },
                    {
                      icon: 'ℹ️',
                      color: 'text-blue-500',
                      text: 'Nueva cancha agregada: "Cancha de Pádel 3"',
                      time: 'Hace 2 horas'
                    }
                  ].map((activity, index) => (
                    <div key={index} className="flex gap-4">
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${activity.color} bg-opacity-10 ${activity.color.replace('text-', 'bg-')}`}>
                        {activity.icon}
                      </div>
                      <div>
